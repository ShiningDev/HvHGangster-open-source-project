...
void D::SetupFonts()
{
	...
	I::Surface->SetFontGlyphSet(F::Watermark = I::Surface->Create_Font(), charenc("MS Sans Serif"), 12, 800, FW_DONTCARE, NULL, NULL, FONTFLAG_OUTLINE);
	I::Surface->SetFontGlyphSet(F::Build = I::Surface->Create_Font(), charenc("MS Sans Serif"), 12,800, FW_DONTCARE, NULL, NULL, FONTFLAG_OUTLINE);
	I::Surface->SetFontGlyphSet(F::MenuTab = I::Surface->Create_Font(), charenc("badcache"), 10, 500, FW_DONTCARE, NULL, NULL, FONTFLAG_DROPSHADOW | FONTFLAG_OUTLINE);
}
...
void D::DrawLine2(int x1, int y1, int x2, int y2, Color col)
{
	int width = 0;
	int height = 0;
